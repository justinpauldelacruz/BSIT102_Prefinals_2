...
public class paulfin {
	...
	public static void main(String[] args) throws IOException {
		...
		while (Running == true) {                                                        // sets the while of the bool to true
			...
			String letter =  in.next();                                                  //Shows input while the bool is true
			  ...
			  if (!letter.equals(":q")) {                           					 // if the user inputs a :q 
				  ...
				  String Filename = in.next();                                            // The Input to type the Filename

				  Writer files = new FileWriter(Filename +".TY");                         // To save the Input file into a file with an extension
